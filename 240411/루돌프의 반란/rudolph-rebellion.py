...
for t in range(1, m + 1):
    ...
    for i in range(1, p + 1):
        ...
        currentBest = (calDist(closestX ,rudolf[0],closestY ,rudolf[1]),-closestX, -closestY)
        currentValue = (calDist(pos[i][0],rudolf[0],pos[i][1],rudolf[1]), -pos[i][0], -pos[i][1])
    ...
    for i in range(1, p+1):
        ...
        minDist = calDist(pos[i][0], rudolf[0], pos[i][1], rudolf[1])
        moveDir = -1
        ...
        for dir in range(4):
            ...
            dist = calDist(nx, rudolf[0], ny, rudolf[1])
            if dist < minDist:
                minDist = dist
                moveDir = dir
